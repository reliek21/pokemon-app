...
import {getPokemonId, getPokemonName, getPokemonsStatic} from "@/services";
...
export default async function PokemonPage({ params }: IPokemonPage) {
  const pokemon = await getPokemonId(params.name);

  return (
    <div className="flex mt-5 flex-col items-center text-slate-800">
      <div
        className="relative flex flex-col items-center rounded-[20px] w-[700px] mx-auto bg-white bg-clip-border  shadow-lg  p-3">
        ...
        <div className="grid grid-cols-2 gap-4 px-2 w-full">
          ...
          <div
            className="flex flex-col items-start justify-center rounded-2xl bg-white bg-clip-border px-3 py-4  drop-shadow-lg ">
